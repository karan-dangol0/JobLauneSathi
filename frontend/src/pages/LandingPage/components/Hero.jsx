...
const Hero = () => {
  ...
  const user = { fullName: "Karan Dangol", role: "employer" };
  const navigate = useNavigate();

  const stats = [
    { icon: Users, label: "Active users", value: "2.4M+" },
    { icon: Building2, label: "Users", value: "50K+" },
        ...
        <div className="max-w-4xl mx-auto text-center ">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group bg-linear-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-300 shadow-lg hover:shadow-md flex items-center space-x-2"
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-3 max-w-2xl mx-auto"
          >
            {stats.map((stat, index) => (
              ...
              >
                <div className="w-12 h-12 bg-linear-to-r  from-blue-100 to-purple-100 flex justify-center items-center rounded-xl e mb-2">
