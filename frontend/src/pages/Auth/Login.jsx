      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="">
            ...
            {formState.errors.email && (
              <p className="text-red-500 text-sm mt-1 flex items-center">
                <AlertCircle className="text-red-500 w-4 mr-1" />
                {formState.errors.email}
              </p>
            )}
          </div>
          ...
          <div className="">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full pl-10 py-3 rounded-lg border ${formState.errors.password ? "border-red-500 " : "border-gray-300"} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
          ...
          <button
            ...
            className="w-full bg-linear-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center space-x-2 mb-4"
          >
            {formState.loading ? (
              <>
